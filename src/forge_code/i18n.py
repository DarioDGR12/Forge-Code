...
STRINGS = {
    "en": {
        ...
        "menu_help": "help",
        "menu_files": "files",
        "menu_open_files": "open files folder",
        "menu_peek": "peek last file",
        "menu_journal": "journal",
        "menu_why": "last QA",
        "empty_journal": "journal is empty",
        "why_empty": "no QA report yet — run a turn that writes files",
        "opened": "opened {path}",
        "open_failed": "could not open {path} — install xdg-open or open the folder yourself",
        "noted": "noted in memory",
        "empty_peek": "nothing to peek — ask Forge to write something first",
        "grep_usage": "usage: /grep <pattern> [path]",
        "cat_usage": "usage: /cat <path>",
        "ls_empty": "no matching files",
        "help_title": "help",
        "help_about": "about",
    ...
    "es": {
        ...
        "menu_help": "ayuda",
        "menu_files": "archivos",
        "menu_open_files": "abrir carpeta files",
        "menu_peek": "ver último archivo",
        "menu_journal": "diario",
        "menu_why": "último QA",
        "empty_journal": "el diario está vacío",
        "why_empty": "aún no hay QA — pide a Forge que escriba algo",
        "opened": "abierto {path}",
        "open_failed": "no se pudo abrir {path} — instala xdg-open o abre la carpeta a mano",
        "noted": "anotado en memoria",
        "empty_peek": "nada que ver — pide a Forge que escriba algo",
        "grep_usage": "uso: /grep <patrón> [ruta]",
        "cat_usage": "uso: /cat <ruta>",
        "ls_empty": "sin archivos",
        "help_title": "ayuda",
